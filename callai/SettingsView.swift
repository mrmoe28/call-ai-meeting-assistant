                ...
                Section(header: Text("Appearance")) {
                    HStack {
                        Image(systemName: prefersDarkMode ? "moon.fill" : "sun.max.fill")
                            .foregroundColor(prefersDarkMode ? AppColor.brandPurple : .orange)
                            .frame(width: 24)
...
#Preview {
    @Previewable @State var darkMode = true
    return SettingsView(prefersDarkMode: Binding.constant(darkMode))
}